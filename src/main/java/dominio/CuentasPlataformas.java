...
public class CuentasPlataformas {
    ...
    public CuentasPlataformas(String estado) {
        this.estado = estado;
    }

    public CuentasPlataformas(int idCuenta, String email, String password, String plataforma, String fecha_creacion, String fecha_vencimiento, String estado) {
