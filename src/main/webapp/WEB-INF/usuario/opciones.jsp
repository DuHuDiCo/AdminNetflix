<section class="p-5">
    ...
    <div class="row">
        ...
        <div class="col m-3 shadow-lg p-3 mb-5 bg-white rounded">
            <div class="card p-5 border-0">
                <div class="card-body text-center">
                    <h5 class="card-title">Ver Cuentas </h5>
                    <a href="ServletControlador?accion=verCuentas" class="btn btn-primary"><i class="fas fa-search"></i>Ver Cuentas</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col m-3 shadow-lg p-3 mb-5 bg-white rounded">
            <div class="card p-5 border-0">
                <div class="card-body text-center">
                    ...
                    <a href="ServletControlador?accion=todasCuentas" class="btn btn-primary">Ver Cuentas</a>
                </div>
            </div>
        </div>
